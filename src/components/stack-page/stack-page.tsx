...
export const StackPage: React.FC = () => {
  ...
  const [stack] = useState(
    new Stack<{ value: string; state: ElementStates }>()
  );
  ...
  return (
    <SolutionLayout title="Стек">
      <div className={styles.wrapper}>
        ...
        <Button
          disabled={isLoadDeleteButton || inputValue === ""}
          isLoader={isLoadAddButton}
          onClick={onAddButtonClick}
          extraClass={"mr-6"}
          text={"Добавить"}
        />
        <Button
          disabled={isLoadAddButton}
          isLoader={isLoadDeleteButton}
          onClick={onDeleteButtonClick}
          extraClass={"mr-40"}
          text={"Удалить"}
        />
        <Button
          disabled={isLoadDeleteButton || isLoadAddButton}
